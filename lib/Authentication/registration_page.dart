import 'package:advocate/models/UserModel.dart';
...
class RegistrationState extends StatefulWidget {
  const RegistrationState({Key? key}) : super(key: key);

  @override
  State<RegistrationState> createState() => _RegistrationStateState();
}

class _RegistrationStateState extends State<RegistrationState> {
  // our form key
